...
# ------------------------------
# Niederschlags-Farben 6h (tp-6h)
# ------------------------------
prec_bounds = [0.0, 0.5, 1, 2, 3, 5, 7, 10, 15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100, 125, 150, 200, 300]
...
COLORMAPS = {
    ...
    "tp6h": (prec_colors, prec_norm),
    "cloud": (cloud_colors, cloud_norm)
}
